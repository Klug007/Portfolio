...
const Hero = () => {
  return (
    <div className="pb-20 pt-36">
      ...
      <div className="h-screen absolute top-0 left-0 w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.03] bg-grid-black/[0.2] flex items-center justify-center">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Привет, я Ёсинбек, разработчик на React.js из Узбекистана
          </p>

          <a href="#about">
            <MagicButton
              title="Посмотреть на мои работы"
