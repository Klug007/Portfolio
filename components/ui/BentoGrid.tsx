...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("tilla.yosinbek@gmail.com");
    setCopied(true);
  };
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(56,56,97,1) 26%, rgba(0,212,255,1) 100%)",
      }}
    >
